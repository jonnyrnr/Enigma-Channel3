...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M17 12a3 3 0 1 0-5.998.001A3 3 0 0 0 17 12Z" />
    <path d="M12 5a3 3 0 1 0 5.998.001A3 3 0 0 0 12 5Z" />
    <path d="M12 19a3 3 0 1 0 5.998.001A3 3 0 0 0 12 19Z" />
    <path d="M7 12a3 3 0 1 0 5.998.001A3 3 0 0 0 7 12Z" />
    <path d="M10.83 7.17A3.001 3.001 0 0 0 14.17 10" />
    <path d="M10.83 16.83A3.001 3.001 0 0 0 14.17 14" />
    <path d="m14.17 10 2.5-4.33" />
    <path d="m9.83 7.17-2.5-4.33" />
    <path d="m14.17 14 2.5 4.33" />
    <path d="m9.83 16.83-2.5 4.33" />
  </svg>
);
...
export const PaletteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.668 0-.92-.742-1.667-1.648-1.667-.926 0-1.648-.746-1.648-1.668 0-.92.742-1.667-1.648-1.667A6.5 6.5 0 0 0 5.5 12c0-3.58 2.92-6.5 6.5-6.5s6.5 2.92 6.5 6.5c0 .926-.746 1.648-1.668 1.648-.92 0-1.667.742-1.667 1.648 0 .926.746 1.648 1.668 1.648.92 0 1.667.742 1.667 1.648A10 10 0 0 0 22 12c0-5.5-4.5-10-10-10z" />
    </svg>
);
...
export const TwitterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3 7.1 0 .2-.1 .4-.2 .5-.2 .2-.4 .3-.7 .3H3.4c-.3 0-.5-.1-.7-.3s-.2-.3-.2-.5c.3-2.2 2-5.7 3.5-7.1C4.7 6.1 4 4 4 4s1.3 1.2 3.3 2.6c2.4-1.9 5.3-2.6 8.7-2.6.2 0 .4 0 .6.1.1 0 .2.1.3.1z"/>
    </svg>
);
...
export const TiktokIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M21 8v4a6 6 0 0 1-6 6h-2a2 2 0 0 0-2 2v0a2 2 0 0 0 2 2h2a10 10 0 0 0 10-10V8a2 2 0 0 0-2-2h-2.5"/>
        <path d="M3 8v4a6 6 0 0 0 6 6h0"/>
